...
export const createDbQuery = ({comment_id, task_id, user_id, context}: RequestParamsType) => `
    ...
    VALUES ($comment_id, $task_id, $user_id, $context, IF($create_at IS NULL, CurrentUtcDatetime(), $create_at), CurrentUtcDatetime());
`;
